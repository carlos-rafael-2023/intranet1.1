...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-success">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('update', ['id'=>$dados->id]) }}" method="Post">
                @csrf
                <div class="card-body">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Produto</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="produto"id="inputEmail3" value="{{$dados->produto}}" placeholder="Nome do Produto">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Preço</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="preco"id="inputPassword3" value="{{$dados->preco}}" placeholder="Valor do Produto">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Marca</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="marca" id="inputPassword3" value="{{$dados->marca}}" placeholder="Marca">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="quantidade" id="inputPassword3" value="{{$dados->quantidade}}" placeholder="Quantidade">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Codigos de Barras</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="codigo_barras" id="inputPassword3" value="{{$dados->codigo_barras}}" placeholder="Codigos de Barras">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
