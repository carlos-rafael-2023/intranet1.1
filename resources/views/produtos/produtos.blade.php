...
<div class="wrapper">
  ...
  @endif
    ...
    <a href="cadastrar" class="btn btn-success"><i class="fas fa-plus"></i> Novo Probuto</a>
  </div>
  <br>
  <tr>
      ...
      <th scope="col">Tipo de remessa</th>
    ...
    <tr>
      ...
      <td>
       <a href="{{ route('editar', $dado->id)}}" class="btn btn-info btn-xs"> <i class="fa fa-edit"></i> Alterar</a>
       <a href="{{ route('produtos.excluir', $dado->id)}}" class="btn btn-danger btn-xs" onclick=" return confirm('Tem certeza que deseja excluir este produto?')"> <i class="fa fa-trash"></i> Excluir</a>
      </td>
    </tr>
   @endforeach
  </tbody>
